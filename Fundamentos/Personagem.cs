...
namespace Fundamentos
{
    public class Personagem
    {
        ...
        {
            int pontosAtaque = 0;
            pontosAtaque = (this.Inteligencia + this.Forca + this.Agilidade + this.Nivel + this.Vida);
            return pontosAtaque;
        }
        public virtual int defender()
        {
            int pontosDefesa = 0;
            pontosDefesa = (this.Inteligencia + this.Forca + (this.Agilidade * 2) + this.Nivel + this.Vida) / 5;
            return pontosDefesa;
        }
